        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OdometerKm = table.Column<double>(type: "float", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Drivers_ContactInfos_ContactInfoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assignments_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_CarId_DriverId",
                table: "Assignments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRecords_CarId_Date",
                table: "MaintenanceRecords",
                columns: new[] { "CarId", "Date" });

            migrationBuilder.CreateIndex(
                name: "IX_TripLogs_CarId",
                table: "TripLogs",
                column: "CarId");
        }
